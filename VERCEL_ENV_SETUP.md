...
|--------------|-------|-------------|
| `VITE_FIREBASE_API_KEY` | `AIzaSyDsL1GzS8uJ6AX4HOWtklGFH_qcJ7UCcX8` | Firebase API Key |
...
3. Enter the **Value** (e.g., `AIzaSyDsL1GzS8uJ6AX4HOWtklGFH_qcJ7UCcX8`)
...
```
VITE_FIREBASE_API_KEY=AIzaSyDsL1GzS8uJ6AX4HOWtklGFH_qcJ7UCcX8
