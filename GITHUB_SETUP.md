...
git remote add origin https://github.com/YOUR_USERNAME/us-national-parks-map.git
...
```bash
git remote add origin git@github.com:YOUR_USERNAME/us-national-parks-map.git
git branch -M main
git push -u origin main
```
